/* Signal Ledger component: the primary workspace treats verification and copying as precise route-control moments with explicit state feedback. */
"use client";
...
export function LinkShortener() {
  ...
  function resetCaptcha() {
    ...
    setRecaptchaRefreshKey((value) => value + 1);
  }
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!recaptchaToken) {
      toast.error("Selesaikan verifikasi anti-spam sebelum membuat link.");
      return;
    }
    ...
    try {
      const response = await fetch("/api/links", {
        ...
        body: JSON.stringify({ originalUrl, customCode: showCustomCode ? customCode : undefined, recaptchaToken }),
      });
